// asr-onnx/speaker-embedding-extractor-model.cc
//
 

#include "asr-onnx/speaker-embedding-extractor-model.h"
...
#include "asr-onnx/speaker-embedding-extractor-model-meta-data.h"
