// asr-onnx/csrc/piper-phonemize-lexicon.h
//
...
#include "asr-onnx/csrc/offline-tts-kokoro-model-meta-data.h"
#include "asr-onnx/csrc/offline-tts-matcha-model-meta-data.h"
