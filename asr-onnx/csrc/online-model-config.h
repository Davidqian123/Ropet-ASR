// asr-onnx/csrc/online-model-config.h
//
...
#include "asr-onnx/csrc/online-nemo-ctc-model-config.h"
#include "asr-onnx/csrc/online-paraformer-model-config.h"
#include "asr-onnx/csrc/online-transducer-model-config.h"
#include "asr-onnx/csrc/online-wenet-ctc-model-config.h"
#include "asr-onnx/csrc/online-zipformer2-ctc-model-config.h"
