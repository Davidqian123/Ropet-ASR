// asr-onnx/csrc/offline-tts-model-config.h
//
...
#include "asr-onnx/csrc/offline-tts-kokoro-model-config.h"
#include "asr-onnx/csrc/offline-tts-matcha-model-config.h"
#include "asr-onnx/csrc/offline-tts-vits-model-config.h"
