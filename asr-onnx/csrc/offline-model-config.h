// asr-onnx/csrc/offline-model-config.h
//
...
#include "asr-onnx/csrc/offline-fire-red-asr-model-config.h"
#include "asr-onnx/csrc/offline-moonshine-model-config.h"
#include "asr-onnx/csrc/offline-nemo-enc-dec-ctc-model-config.h"
#include "asr-onnx/csrc/offline-paraformer-model-config.h"
#include "asr-onnx/csrc/offline-sense-voice-model-config.h"
#include "asr-onnx/csrc/offline-tdnn-model-config.h"
#include "asr-onnx/csrc/offline-transducer-model-config.h"
#include "asr-onnx/csrc/offline-wenet-ctc-model-config.h"
#include "asr-onnx/csrc/offline-whisper-model-config.h"
