// asr-onnx/csrc/speaker-embedding-extractor-nemo-model.cc
//
 

#include "asr-onnx/csrc/speaker-embedding-extractor-nemo-model.h"
...
#include "asr-onnx/csrc/speaker-embedding-extractor-nemo-model-meta-data.h"
