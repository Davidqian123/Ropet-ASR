// asr-onnx/offline-model-config.h
//
...
#include "asr-onnx/offline-fire-red-asr-model-config.h"
#include "asr-onnx/offline-moonshine-model-config.h"
#include "asr-onnx/offline-nemo-enc-dec-ctc-model-config.h"
#include "asr-onnx/offline-paraformer-model-config.h"
#include "asr-onnx/offline-sense-voice-model-config.h"
...
#include "asr-onnx/offline-whisper-model-config.h"
#include "asr-onnx/offline-zipformer-ctc-model-config.h"
