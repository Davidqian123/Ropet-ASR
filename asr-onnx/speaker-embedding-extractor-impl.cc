// asr-onnx/speaker-embedding-extractor-impl.cc
//
 
#include "asr-onnx/speaker-embedding-extractor-impl.h"
...
#include "asr-onnx/speaker-embedding-extractor-general-impl.h"
#include "asr-onnx/speaker-embedding-extractor-nemo-impl.h"
