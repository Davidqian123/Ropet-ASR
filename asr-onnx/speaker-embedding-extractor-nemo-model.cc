// asr-onnx/speaker-embedding-extractor-nemo-model.cc
//
 

#include "asr-onnx/speaker-embedding-extractor-nemo-model.h"
...
#include "asr-onnx/session.h"
#include "asr-onnx/speaker-embedding-extractor-nemo-model-meta-data.h"
